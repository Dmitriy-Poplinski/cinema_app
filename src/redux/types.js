const  FETCH_PREMIERES = 'PREMIERES/FETCH_PREMIERES'
const  ASYNC_FETCH_PREMIERES = 'PREMIERES/ASYNC_FETCH_PREMIERES'

const  FETCH_MOVIES_TODAY = 'TODAY/FETCH_MOVIES_TODAY'
const  ASYNC_FETCH_MOVIES_TODAY = 'TODAY/ASYNC_FETCH_MOVIES_TODAY'

const  FETCH_MOVIES_TOMMOROW = 'TOMMOROW/FETCH_MOVIES_TOMMOROW'
